...
class WeChatOAuth
{
    ...
    private $appsecret;
    private $siteurl;
    public function __construct($appid = '', $appsecret = '', $siteurl = '') {
        $this->appid = $appid;
        $this->appsecret = $appsecret;
        $this->siteurl = $siteurl;
        // $this->appid = C('WX_APPID');
        // $this->appsecret = C('WX_APPSECRET');
        // $this->siteurl = C('WX_SITEURL');
    }
    ...
    public function getCode($redirect_uri, $state = 1, $scope = 'snsapi_base') {
        ...
        $redirect_uri = $this->siteurl . $redirect_uri;
    ...
    public function refreshToken($refreshToken) {
        $queryUrl = 'https://api.weixin.qq.com/sns/oauth2/refresh_token?appid=' . $this->appid . '&grant_type=refresh_token&refresh_token=' . $refreshToken;
        $queryAction = 'GET';
