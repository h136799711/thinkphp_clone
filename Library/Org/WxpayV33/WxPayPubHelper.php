...
class Common_util_pub
{
    ...
    //异步通知url，商户根据实际开发过程设定
    	 'NOTIFY_URL' => 'http://net.gooraye.net/a/gai/index.php/Home/Wxpay/notify', 
     ...
     *  @param [type] $config [配置] array('APPID'=>,'MCHID'=>,'KEY'=>,'APPSECRET'=>
     *                        				'JS_API_CALL_URL'=>,'SSLCERT_PATH'=>,'SSLKEY_PATH'=>)
     */
...
class Wxpay_client_pub extends Common_util_pub
{
     ...
     */
    function createXml() {
        $this->parameters["appid"] = $this->config['APPID'];
         //公众账号ID
...
class NativeCall_pub extends Wxpay_server_pub
{
    ...
    function createXml() {
        if ($this->returnParameters["return_code"] == "SUCCESS") {
            $this->returnParameters["appid"] = $this->config['APPID'];
             //公众账号ID
            $this->returnParameters["mch_id"] = $this->config['MCHID'];
             //商户号
